...
{ 
  ...
  /*Los sensores tienen el mismo numero que el indicado en el robot.*/
  //HOYGAN, a mayor luz, menor resistencia ofrecida por las LDR, y mayor tension obtenida. GRASIAS DE ANTEBRASO
