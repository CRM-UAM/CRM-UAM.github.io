...
// ----------- FRONT HOLES --------------
// Move reference to front center
translate([servo_c4+servo_c8 +17, servo_c3, servo_c9+servo_c10 -15]) {
	translate([0,-screwSep/2,0])
		rotate([0,90,0]) cylinder(r=3.5/2, h=10, center=true, $fn=20);
	translate([0,screwSep/2,0])
		rotate([0,90,0]) cylinder(r=3.5/2, h=10, center=true, $fn=20);
}
...
translate([27,60,40])rotate([180,0,0])rotate([0,0,90])soporteUltraSonidos(altura=100,anchura=45);
//translate([0,7,30])cube([10,43,5]);
