...
\begin{itemize}
	\item Breve introducción a OpenSCAD
	\item Pequeños ejercicios por parejas para poner en práctica lo aprendido.
	\item Exposición de los robots que se han construido con la impresora 3D enn el CRM.
	\item Diseño libre por parejas de piezas imprimibles para la construcción de un robot.
	\item Explicación del funcionamiento de la impresora 3D
	\item Impresión de los mejores diseños que hayan hecho los estudiantes en el taller.
\end{itemize}
\centerline{
...
\item Secretario: \textbf{Jaime Aragón} ( *)
\item Tesorero: \textbf{Cristina Kasner Tourné} (cristina.kasner*)
